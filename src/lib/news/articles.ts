...
export function sortNewsArticles(articles:NewsArticle[]){return [...articles].sort((a,b)=>b.season-a.season||(b.week??0)-(a.week??0)||b.publishedAt.localeCompare(a.publishedAt)||a.slug.localeCompare(b.slug));}
